...
$.fn.lightzoom = function(options) {
    ...
    $("body").append('<div id="glassWrap" style="display:none"><div id="glass"></div></div>');
    $('html > head').append($('<style> #glass{position:absolute; cursor:none; border:3px solid #00b19d; box-shadow: 0px 0px 5px 4px rgba(33,33,33,.4) inset; border-radius: 50%; width: ' + settings.glassSize+ 'px; height: ' + settings.glassSize+ 'px;}</style>'));

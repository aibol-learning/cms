...
<head>
    ...
    <script>
        $(function () {
            ...
            $.get("/api/aibol/GetAdminBySub", { sub: $("#Lv1AdminSub").val() }, function (res) {
                var Lv1AdminSub = $('<select class="form-control"><option value="' + res.data.id + '">' + res.data.text + '</option></select>');
                $("#Lv1AdminSub").after(Lv1AdminSub);
                $("#Lv1AdminSub").hide();
                ...
                Lv1AdminSub.on('change',
                    function (e) {
                        $("#Lv1AdminSub").val(e.target.value);
                    });
            });
    ...
    <form id="myForm" class="m-l-15 m-r-15" enctype="multipart/form-data" runat="server">
        ...
        <div class="card-box">
            ...
            <div class="text-center">
                ...
                <small class="form-text text-muted m-t-5">提示：按CTRL+回车可以快速提交
                </small>
            </div>
